...
public class InveditLabelDialog extends AbstractWYSIWYGDialog<Label> {

    public InveditLabelDialog(InveditGuiEditor editor, @Nullable Label label) {
        super(editor.getFakeEditor(), label);
        setSize(590, 190);
