...
public class InveditEntityModelDialog extends AbstractWYSIWYGDialog<EntityModel> {

    public InveditEntityModelDialog(InveditGuiEditor editor, @Nullable EntityModel model) {
