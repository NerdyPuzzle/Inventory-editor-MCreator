...
public class InventoryRenderer {
	...
	public static void openScreen(ScreenEvent.Init.Pre event) {
		if (!((event.getScreen() instanceof InventoryScreen) || (event.getScreen() instanceof CreativeModeInventoryScreen)<#if hasCurios> || event.getScreen().getClass().getSimpleName().equals("CuriosScreen")</#if>))
			return;
